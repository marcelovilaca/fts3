...
CREATE TABLE `t_file` (
  ...
  PRIMARY KEY (`file_id`, `hashed_id`, `file_state`),
  KEY `idx_job_id` (`job_id`),
  KEY `idx_activity` (`vo_name`,`activity`),
  KEY `idx_state_link_vo` (`file_state`, `source_se`,`dest_se`,`vo_name`),
...
partition by range(`hashed_id`) 
(
    partition p0 VALUES LESS THAN (6554),
    partition p1 VALUES LESS THAN (13108),
    partition p2 VALUES LESS THAN (19662),
    partition p3 VALUES LESS THAN (26216),
    partition p4 VALUES LESS THAN (32770),
    partition p5 VALUES LESS THAN (39324),
    partition p6 VALUES LESS THAN (45878),
    partition p7 VALUES LESS THAN (52432),
    partition p8 VALUES LESS THAN (58986),
